...
I build data platforms for fintech lending. Wrong number → loan doesn't close.

Currently own the full stack — raw ingestion → dbt warehouse on BigQuery → automated financial reports for banking partners. SCD2 dimensional models, fraud feature stores, data quality systems.

---

<sub>ML → production data engineering. The model was never the hard problem.</sub>

<sub>[LinkedIn](https://linkedin.com/in/omerzaman) · [omerzaman.vercel.app](https://omerzaman.vercel.app)</sub>
